    ...
    <div class="row">
      <div class="col-md-5 text-center mb-3">
        <div class="card">
          ...
          <img v-if="product.image" :src="product.image" class="img-fluid mt-2 mb-2 mx-auto" style="width: 400px; height: 400px; object-fit: cover;">
        </div>
      </div>
      <div class="col-md-7 mb-5">
        <div class="card p-3">
          ...
          <p><b>Marca: </b>
            <router-link :to="{ name: 'product-list', params: { brandSlug: product.brand.slug } }" class="text-decoration-none">
              <span>{{ product.brand.name }}</span>
            </router-link>
          </p>
          <p><b>Precio: </b>{{ product.price }}$</p>
          <p><b>Precio en moneda local: </b>
